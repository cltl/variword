./word2vecf/create_init -wvocab small_tests/minicounts.words.vocab -cvocab small_tests/minicounts.contexts.vocab -output minicounts.pinit1.bin
./word2vecf/create_init -wvocab small_tests/minicounts.words.vocab -cvocab small_tests/minicounts.contexts.vocab -output minicounts.pinit2.bin
./word2vecf/create_init -wvocab small_tests/minicounts.words.vocab -cvocab small_tests/minicounts.contexts.vocab -output minicounts.pinit3.bin
